...
void ReadDimmerValue()
{
    ...
    gRequest->send(200, sdefTextHtml, String(vectorLeituraDimmer[0]) + "|" + String(vectorLeituraDimmer[1]) + "|" + String(vectorLeituraDimmer[2]) + "|" + String(vectorLeituraDimmer[3]) + "|" + String(vectorLeituraDimmer[4]) + "*");
}
*/
